...
class CodeGemma_Instruct_7B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the CodeGemma Instruct 7B LLM.
    """
    ...
    def getTag(self) -> str:
        return 'codegemma-instruct-7b'

    def getModelName(self) -> str:
        return 'codegemma-instruct-7b-9b1d9231388358c04d90bd003458f5070d97db44'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = '9b1d9231388358c04d90bd003458f5070d97db44'
    ...
    def toPromptFormat(self, sample:CodeSample):
        ...
        return userPrompt
        #return self.__tokenizer.apply_chat_template({ "role": "user", "content": userPrompt},tokenize=False,chat_template=self.__tokenizer.config.chat_template)
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(CodeGemma_Instruct_7B.__MODEL_MAX_OUTPUT_LENGTH, length)
