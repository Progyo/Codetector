...
class StarCoder2_3B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the StarCoder 2 3B LLM.
    """
    ...
    def getModelName(self) -> str:
        return 'starcoder2-3b-733247c55e3f73af49ce8e9c7949bf14af205928'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = '733247c55e3f73af49ce8e9c7949bf14af205928'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(StarCoder2_3B.__MODEL_MAX_OUTPUT_LENGTH, length)
...
class StarCoder2_7B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the StarCoder 2 7B LLM.
    """
    __MODEL_MAX_OUTPUT_LENGTH = 8096
    ...
    def getModelName(self) -> str:
        return 'starcoder2-7b-a3d33687b51284b528abeb17830776ffd24892a9'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = 'a3d33687b51284b528abeb17830776ffd24892a9'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(StarCoder2_7B.__MODEL_MAX_OUTPUT_LENGTH, length)
