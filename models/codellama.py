...
class CodeLlama_7B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the CodeLlama 7B LLM.
    """
    ...
    def getModelName(self) -> str:
        return 'codellama-7b-6c284d1468fe6c413cf56183e69b194dcfa27fe6'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(CodeLlama_7B.__MODEL_MAX_OUTPUT_LENGTH, length)
...
class CodeLlama_13B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the CodeLlama 13B LLM.
    """
    __MODEL_MAX_OUTPUT_LENGTH = 8096
    ...
    def getModelName(self) -> str:
        return 'codellama-13b-8da65ff4ee20f74ecd107ca9d54f9f121b279860'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = '8da65ff4ee20f74ecd107ca9d54f9f121b279860'
    ...
    def toPromptFormat(self, sample:CodeSample):
        if not isinstance(sample, CodeSample.fromLanguage('generic')):

            return '{}\n{}\n'.format(sample.toComment(f' language: {sample.getPL()}'),
                                    sample.toComment(' '+sample.prompt),)


        return '{}\n'.format(sample.toComment(' '+sample.prompt),)
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(CodeLlama_13B.__MODEL_MAX_OUTPUT_LENGTH, length)
...
class CodeLlama_Instruct_7B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the CodeLlama Instruct 7B LLM.
    """
    __MODEL_MAX_OUTPUT_LENGTH = 8096
    ...
    def getModelName(self) -> str:
        return 'codellama-instruct-7b-22cb240e0292b0b5ab4c17ccd97aa3a2f799cbed'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = '22cb240e0292b0b5ab4c17ccd97aa3a2f799cbed'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(CodeLlama_Instruct_7B.__MODEL_MAX_OUTPUT_LENGTH, length)
...
class CodeLlama_Instruct_13B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the CodeLlama Instruct 13B LLM.
    """
    __MODEL_MAX_OUTPUT_LENGTH = 8096
    ...
    def getTag(self) -> str:
        return 'codellama-instruct-13b'

    def getModelName(self) -> str:
        return 'codellama-instruct-13b-745795438019e47e4dad1347a0093e11deee4c68'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = '745795438019e47e4dad1347a0093e11deee4c68'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(CodeLlama_Instruct_13B.__MODEL_MAX_OUTPUT_LENGTH, length)
