...
class WaveCoderUltra_7B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the WaveCoder Ultra 6.7B LLM.
    """
    ...
    def getTag(self) -> str:
        return 'wavecoderultra-7b'

    def getModelName(self) -> str:
        return 'wavecoderultra-7b-57049dba4025d92e99e786081076df44dacc44a1'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            model_name_or_path = 'microsoft/wavecoder-ultra-6.7b'
            rev = '57049dba4025d92e99e786081076df44dacc44a1'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(WaveCoderUltra_7B.__MODEL_MAX_OUTPUT_LENGTH, length)
