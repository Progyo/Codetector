...
class Llama3_8B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the Llama 3 8B LLM.
    """
    ...
    def getModelName(self) -> str:
        return 'llama3-8b-abf8f1bbc9f1ceefa4e88667311436858dd75de0'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = 'abf8f1bbc9f1ceefa4e88667311436858dd75de0'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(Llama3_8B.__MODEL_MAX_OUTPUT_LENGTH, length)
...
class Llama3_Instruct_8B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the Llama 3 Instruct 8B LLM.
    """
    __MODEL_MAX_OUTPUT_LENGTH = 8096
    ...
    def getTag(self) -> str:
        return 'llama3-instruct-8b'

    def getModelName(self) -> str:
        return 'llama3-instruct-8b-a8977699a3d0820e80129fb3c93c20fbd9972c41'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            ...
            rev = 'a8977699a3d0820e80129fb3c93c20fbd9972c41'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(Llama3_Instruct_8B.__MODEL_MAX_OUTPUT_LENGTH, length)
