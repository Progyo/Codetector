...
class CodeGen25_7B(BaseModel, GeneratorMixin, DetectorMixin):
    """
    Implementation of the Codegen 2.5 LLM.
    Requires this fix: https://huggingface.co/Salesforce/codegen25-7b-mono_P/discussions/4
    """
    ...
    def getTag(self) -> str:
        return 'codegen2_5-7b'

    def getModelName(self) -> str:
        return 'codegen2_5-7b-d85e7275a8b5534b210ba3941e10e12713fcf445'
    ...
    def load(self, outputHiddenStates:bool=False) -> None:
        if not self.isLoaded():
            model_name_or_path = "Salesforce/codegen25-7b-multi"
            rev = 'd85e7275a8b5534b210ba3941e10e12713fcf445'
    ...
    def setMaxOutputLength(self, length:int) -> None:
        self.__outputLength = min(CodeGen25_7B.__MODEL_MAX_OUTPUT_LENGTH, length)
